...
(async function findCarDiffReturn() {
  ...
  try {
    ...
    //locate return to a different location checkbox
    let returnCheckbox = await driver.findElement(By.xpath('//input[@type="checkbox" and contains(@class, "form-check-input")]'));
    ...
    //locate return location 
    let returnLocationField = await driver.findElement(By.id('react-select-return_location-input'));
    ...
    //select Mandalay Airport
    let optionAirport = await driver.findElement(By.xpath('//div[@id="react-select-return_location-option-1-1"]'));
    await optionAirport.click();
