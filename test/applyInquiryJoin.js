...
(async function applyInquiryJoin() {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.xpath('//*[@id="__next"]/div/div[1]/div[2]/div/div[2]/label[2]/span')), 20000);
  
    // verify if button displayed
    let createJoin= await driver.findElement(By.xpath('//*[@id="__next"]/div/div[1]/div[2]/div/div[2]/label[2]/span'));

    //click I want to join my company option
    await createJoin.click();
